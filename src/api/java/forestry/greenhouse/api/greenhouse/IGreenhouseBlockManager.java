...
public interface IGreenhouseBlockManager {
	...
	/**
	 * @return the {@link IGreenhouseBlockHandler} that is used to handle blank block in the {@link IGreenhouseProvider}
	 */
	IGreenhouseBlockHandler<IBlankBlock, IBlankBlock> getBlankBlockHandler();

	/**
	 * @return the {@link IGreenhouseBlockHandler} that is used to handle wall block in the {@link IGreenhouseProvider}
	 */
