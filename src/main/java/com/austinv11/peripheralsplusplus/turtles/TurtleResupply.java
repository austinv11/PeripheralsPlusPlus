...
public class TurtleResupply implements ITurtleUpgrade, ModelManager.ModelRegistrar {
    ...
    public int getLegacyUpgradeID() {
        return Reference.RESUPPLY_UPGRADE_LEGACY;
    }
	...
	public ItemStack getCraftingItem() {
		return new ItemStack(ModItems.RESUPPLY_UPGRADE);
	}
    ...
    public Pair<IBakedModel, Matrix4f> getModel(@Nullable ITurtleAccess turtle, @Nonnull TurtleSide side) {
        return ModelUtil.getTurtleUpgradeModel("turtle_resupply", side);
    }
    ...
    public void registerModels(IRegistry<ModelResourceLocation, IBakedModel> iRegistry) {
        ModelUtil.registerTurtleUpgradeModels(iRegistry, "turtle_resupply");
    }
}
