...
final class huffcodetab {
   ...
   private huffcodetab(String var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8, int[][] var9, int var10) {
      this.tablename0 = var1.charAt(0);
      this.tablename1 = var1.charAt(1);
      this.tablename2 = var1.charAt(2);
      this.xlen = var2;
      this.ylen = var3;
      this.linbits = var4;
      this.linmax = var5;
   ...
   public static int huffman_decoder(huffcodetab var0, int[] var1, int[] var2, int[] var3, int[] var4, BitReserve var5) {
      ...
      if(var0.val == null) {
         return 2;
      } else if(var0.treelen == 0) {
         var1[0] = var2[0] = 0;
         return 0;
      } else {
         do {
            if(var0.val[var9][0] == 0) {
               var1[0] = var0.val[var9][1] >>> 4;
               var2[0] = var0.val[var9][1] & 15;
               var10 = 0;
               break;
            }

            if(var5.hget1bit() != 0) {
               while(var0.val[var9][1] >= 250) {
                  var9 += var0.val[var9][1];
               }

               var9 += var0.val[var9][1];
            } else {
               while(var0.val[var9][0] >= 250) {
                  var9 += var0.val[var9][0];
               }
         ...
         if(var0.tablename0 == 51 && (var0.tablename1 == 50 || var0.tablename1 == 51)) {
            var3[0] = var2[0] >> 3 & 1;
            var4[0] = var2[0] >> 2 & 1;
            var1[0] = var2[0] >> 1 & 1;
            var2[0] &= 1;
            if(var3[0] != 0 && var5.hget1bit() != 0) {
               var3[0] = -var3[0];
            }

            if(var4[0] != 0 && var5.hget1bit() != 0) {
               var4[0] = -var4[0];
            }

            if(var1[0] != 0 && var5.hget1bit() != 0) {
               var1[0] = -var1[0];
            }

            if(var2[0] != 0 && var5.hget1bit() != 0) {
               var2[0] = -var2[0];
            }
         } else {
            if(var0.linbits != 0 && var0.xlen - 1 == var1[0]) {
               var1[0] += var5.hgetbits(var0.linbits);
            }
            ...
            if(var0.linbits != 0 && var0.ylen - 1 == var2[0]) {
               var2[0] += var5.hgetbits(var0.linbits);
            }
